...
class PurchaseHistoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return new PurchaseHistoryMiniCollection($order_query->where('user_id', $user_id)->latest()->paginate(5));
    }
    ...
    public function details($id, Request $request)
    {
        ...
        $order_detail = Order::where('id', $id)->where('user_id', $user_id)->get();
    ...
    public function items($id, Request $request)
    {
        ...
        $order_id = Order::select('id')->where('id', $id)->where('user_id', $user_id)->first();
