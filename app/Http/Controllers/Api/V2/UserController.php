...
use App\Http\Resources\V2\PartyMasterCollection;
...
class UserController extends Controller
{
    ...
    public function customerSaleszing(Request $request)
    {
        $customers = User::with('warehouse', 'manager', 'addresses.city', 'addresses.state')->where('user_type', 'customer')->where('banned', false)->latest()->get();
        return new PartyMasterCollection($customers);
    }
