...
class AddressController extends Controller
{
    public function addresses(Request $request)
    {
        ...
        $addresses = Address::
                    ...
                    // ->where('addresses.user_id', '24181')
                    ->select('addresses.*', 'addresses.city as city_name', 'states.name as state_name', 'countries.name as country_name')
                    ->get();
    ...
    public function updateAddressInCart(Request $request)
    {
        try {
            ...
            Cart::where('customer_id',$user_id)->orWhere('user_id',$user_id)->update(['address_id' => $request->address_id]);
