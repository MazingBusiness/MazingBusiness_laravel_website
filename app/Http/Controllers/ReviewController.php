...
use App\Models\ReviewsDemoExport;
use App\Models\ReviewsImport;
use Auth;
use Excel;
...
class ReviewController extends Controller {
  public function __construct() {
    ...
    $this->middleware(['permission:add_product_review'])->only('uploadBulk');
  }
  ...
  public function reviewDemoExport() {
    return Excel::download(new ReviewsDemoExport, 'reviews_bulk_demo.xlsx');
  }
