  ...
  public function pay() {
    if (Session::has('payment_type')) {
      if (Session::get('payment_type') == 'cart_payment') {
        ...
        return view('frontend.ccavenue.order_payment_ccavenue', compact('combined_order'));
      } elseif (Session::get('payment_type') == 'wallet_payment') {
        return view('frontend.ccavenue.wallet_payment_ccavenue');
      } elseif (Session::get('payment_type') == 'customer_package_payment') {
        return view('frontend.ccavenue.customer_package_payment_ccavenue');
      } elseif (Session::get('payment_type') == 'seller_package_payment') {
        return view('frontend.ccavenue.seller_package_payment_ccavenue');
      }
    }
  }
