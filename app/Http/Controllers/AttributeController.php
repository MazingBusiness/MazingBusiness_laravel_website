...
class AttributeController extends Controller
{
    ...
    public function index()
    {
        ...
        $attributes = Attribute::orderBy('created_at', 'desc')->paginate(10); // Replace 10 with the desired items per page
    ...
    public function importAttributes(Request $request)
    {
        ...
        // Use the AttributesImport class to handle the import
