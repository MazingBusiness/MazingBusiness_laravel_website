...
<body>
    ...
    <div class="customer-info">
        <p><span class="highlight">Party Name:</span> {{ $invoice->shop->name ?? 'N/A' }}</p>
        <p><span class="highlight">Invoice No:</span> {{ $invoice->purchase_no ?? 'N/A' }}</p>
