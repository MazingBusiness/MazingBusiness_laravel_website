                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @endphp
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('international_pending_order_details',['id'=>encrypt($order->id)]) }}" title="{{ translate('View') }}">
                       ...
                       <!--  <td>
                            <a href="#" class="btn btn-success btn-icon btn-circle btn-sm send-whatsapp" data-order-id="{{ $order->id }}" title="{{ translate('Send WhatsApp') }}">
...
<script>
    $(document).on('click', '.send-whatsapp', function(e) {
        ...
        $button.html('<div class="loader"></div>');
         ...
         // var url = "{{ url('send-whatsapp-message') }}/" + orderId; // Construct the U
