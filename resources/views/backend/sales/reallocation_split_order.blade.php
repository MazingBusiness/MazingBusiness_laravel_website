...
<style>
  ...
  <form class="form form-horizontal mar-top" action="{{ route('order.saveReAllocationOrder') }}" method="POST" enctype="multipart/form-data" id="split_order_form">
    @csrf
    ...
    <input type="hidden" class="form-control" name="sub_order_details_id" value="{{ $sub_order_details_id }}">
    <div class="row gutters-5">
          ...
          <div class="card-body row">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control" name="party_name" value="{{ $order_warehouse->name }}" readonly>
                </div>
              </div>
              <?php /*
              <div class="form-group row">
      ...
      <div class="col-lg-12">
              ...
              <tbody>
                ...
                @foreach($subOrderDetailsData as $orderDetail)
                  @php
                      ...
                      $mumbaiQty = $subOrderProductQty ?? old('Mumbai_allocate_qty_' . $orderDetail->order_details_id);
                  ...
                  @endphp
                  @if(($orderDetail->pre_closed + $orderDetail->reallocated + $orderDetail->challan_qty) < $orderDetail->approved_quantity)
                    <tr id="row_{{$count}}">      
                        ...
                        <td style="display: table-cell;">
                          <input type="text" class="form-control" name="order_qty_{{ $orderDetail->order_details_id }}" id="order_qty_{{ $orderDetail->order_details_id }}" value="{{ $orderDetail->approved_quantity }}" readonly>
                          <div class="col-md-12" style="text-align: center;">
                            <strong>{{ optional($orderDetail->product_data->stocks->where('warehouse_id', 1)->first())->qty + optional($orderDetail->product_data->stocks->where('warehouse_id', 2)->first())->qty + optional($orderDetail->product_data->stocks->where('warehouse_id', 6)->first())->qty }}</strong>
                          </div>
                        </td>
                        <td style="display: table-cell;">
                          <input type="number" class="form-control allocate-qty-input" name="Kolkata_allocate_qty_{{ $orderDetail->order_details_id }}" value="{{ old("Kolkata_allocate_qty_{$orderDetail->id}", $kolQty != '0' ? $kolQty : '' }}"> 
                          
                          <div class="form-group row">
                            <div class="col-md-12" style="text-align: center;">
                              <strong>{{ optional($orderDetail->product_data->stocks->where('warehouse_id', 1)->first())->qty }}</strong>
                            </div>
                          </div>                          
                        </td>
                        <td style="display: table-cell;">
                          <input type="number" class="form-control allocate-qty-input" name="Delhi_allocate_qty_{{ $orderDetail->order_details_id }}" value="{{ old("Delhi_allocate_qty_{$orderDetail->id}",$delhiQty != '0' ? $delhiQty : '' }}">
                          <div class="form-group row">
                            <div class="col-md-12" style="text-align: center;">
                              <strong>{{ optional($orderDetail->product_data->stocks->where('warehouse_id', 2)->first())->qty }}</strong>
                            </div>
                          </div>
                        </td>
                        <td style="display: table-cell;">
                          <input type="number" class="form-control allocate-qty-input" name="Mumbai_allocate_qty_{{ $orderDetail->order_details_id }}" value="{{ old("Mumbai_allocate_qty_{$orderDetail->id}", $mumbaiQty != '0' ? $mumbaiQty : '' }}">
                          <div class="form-group row">
                            <div class="col-md-12" style="text-align: center;">
                              <strong>{{ optional($orderDetail->product_data->stocks->where('warehouse_id', 6)->first())->qty }}</strong>
                            </div>
                          </div>
                        </td>
                        <td style="display: table-cell;">
        ...
        <div>
          ...
          <span style="float: right; margin-right: 10px; padding-top: 13px; font-size: 15px;"><input type="checkbox" name="btr_verification" id="btr_verification" value="1" {{ $checked }}> BTR Verified</span>
        </div>
        <br/>
      </div>
    </div>
