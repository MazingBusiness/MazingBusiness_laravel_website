                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            @php
                                // bas ye line conditional kar do
                                $getSplitOrder = ($is41Manager ?? false)
                                    ? App\Models\Manager41SubOrder::where('code', $order->code)->first()
                                    : App\Models\SubOrder::where('code', $order->code)->first();

                                $data_status = $getSplitOrder ? 1 : 0;
                            @endphp
                            ...
                            <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                                href="{{ ($is41Manager ?? false)
                                            ? route('manager41.invoice.download', $order->id)
                                            : route('invoice.download', $order->id) }}"
