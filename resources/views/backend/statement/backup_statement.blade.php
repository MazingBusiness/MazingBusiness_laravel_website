...
<div class="card">
   <!--  <div class="card-header">
    ...
    <div class="card-body">
        <!-- Search and Filters -->
        <form method="GET" action="{{ route('adminBackupStatement') }}">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3" >
            <div style="background-color: white; color: black; padding: 9px 14px; border-radius: 10px; font-size:13px;">
                <h4 style="font-size: 15px;">
                    Total Due Amount: <strong>₹{{ number_format($totalDueAmount, 2) }}</strong>
                </h4>
            </div>
            <div style="background-color: white; color: black; padding: 9px 14px; border-radius: 10px; font-size:13px;">
                <h4 style="font-size: 15px;">
                    Total Overdue Amount: <strong>₹{{ number_format($totalOverdueAmount, 2) }}</strong>
                </h4>
            </div>
        </div>
