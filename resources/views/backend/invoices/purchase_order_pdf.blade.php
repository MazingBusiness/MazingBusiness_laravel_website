        ...
        <div style="padding: 1rem;">
            <table class="padding text-left small border-bottom">
                ...
                <tbody class="strong">
                    ...
                    @php
                        // Fetch the product thumbnail using the part_no
                    ...
                    @endphp
                        ...
                        <tr>
                            ...
                            <td>
                                <img style="width:50px;height:50px;" class="img-fit lazyload mx-auto" src="{{ uploaded_asset($product->thumbnail_img) }}" alt="" 
                                     onerror="this.onerror=null;this.src='{{ static_asset("assets/img/placeholder.jpg") }}';">
                            </td>
                            <td>{{ $item['qty'] }}</td>
                            {{-- <td class="text-left">{{ number_format($item['purchase_price'], 2) }}</td> --}}
