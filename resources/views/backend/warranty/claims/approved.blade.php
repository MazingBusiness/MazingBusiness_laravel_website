...
<style>
  ...
  .chip.ok{ background:rgba(16,185,129,.1); color:#065f46; }
...
<div class="aiz-titlebar text-left mt-2 mb-3 page-head">
  <h1 class="h3">{{ translate('Warranty — Approved Claims') }}</h1>
  <div class="meta">
...
<div class="card">
  <form action="{{ route('claims.approved') }}" method="GET">
    {{-- Search toolbar --}}
    <div class="card-header search-wrap" style="padding:12px;">
      <div class="d-flex align-items-center">
        ...
        @if(request('search'))
          <a href="{{ route('claims.approved') }}" class="btn btn-outline-secondary btn-clear">
          ...
          <tbody>
            @forelse ($claims as $claim)
              <tr>
                ...
                <td>
                  <span class="chip ok">
                    <span class="dot"></span> {{ translate('Approved') }}
                  </span>
                </td>
                ...
                <td class="text-right">
                  <div class="btn-group" role="group" aria-label="Row actions">
                    ...
                    {{-- Approved list row action --}}
                    <a href="{{ route('claims.show', ['id' => $claim->id, 'from' => 'approved']) }}"
            ...
            @empty
              <tr>
                <td colspan="7" class="text-center text-muted py-5">
                  ...
                  {{ translate('No approved claims found') }}
                </td>
              </tr>
            @endforelse
          </tbody>
