@php
    ...
    if (!$user->hasPermissionTo('view_all_orders')) {
        ...
        if (in_array($user->id, $allowedUserIds) || ($staff && $staff->role_id == 4)) {
            $user->givePermissionTo('view_all_orders','show_all_products');
        }
    }

    if ($user->id == 169) {
        $user->givePermissionTo('show_all_products');
        $user->givePermissionTo('product_edit');
    }
    if ($user->id == 27083 || $user->id == 27084 || $user->id == 27085 || $user->id == 25606) {
        $user->givePermissionTo('show_all_products');
    }
...
@php
    ...
    // treat any common stored form as 41 Manager
    $is41Manager = in_array($title, ['manager_41'], true);
@endphp

<div class="aiz-sidebar-wrap">
  <div class="aiz-sidebar left c-scrollbar">
    <div class="aiz-side-nav-logo-wrap d-flex align-items-center p-3">
        ...
        <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
          ...
          <li class="aiz-side-nav-item">
            <a href="#" class="aiz-side-nav-link">
              ...
              <span class="aiz-side-nav-text">{{ translate('Domestic') }}</span>
              <span class="aiz-side-nav-arrow"></span>
            </a>
            <!-- Products Submenu -->
            <ul class="aiz-side-nav-list level-2" style="list-style-type: none; padding-left: 0; margin-left: 0;">
              ...
              <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                  ...
                  <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-3">
                      @can('add_new_product')
                        ...
                        <li class="aiz-side-nav-item">
                          <a class="aiz-side-nav-link {{ areActiveRoutes(['uploaded-files.create']) }}"
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Upload Product Images') }}</span>
                          </a>
                        </li>
                      @endcan
                      ...
                      @can('product_bulk_export')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('product_bulk_export.products') }}" class="aiz-side-nav-link">
                      ...
                      @endcan
                      @can('show_all_warehouses')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('warehouses.index') }}" class="aiz-side-nav-link">
                      ...
                      @endcan
                      <li class="aiz-side-nav-item">
                        <a href="{{ route('products.closingStock') }}"
                          class="aiz-side-nav-link {{ areActiveRoutes(['products.closingStock']) }}">
                          <span class="aiz-side-nav-text">{{ translate('Closing Stock') }}</span>
                        </a>
                      </li>

                      <li class="aiz-side-nav-item">
                          <a href="{{ route('mark_as_lost.page') }}"
                              class="aiz-side-nav-link {{ areActiveRoutes(['mark_as_lost.page']) }}">
                              <span class="aiz-side-nav-text">{{ translate('Mark As Lost') }}</span>
                          </a>
                      </li>
                    </ul>
                  </li>
                    ...
                    <ul class="aiz-side-nav-list level-3">
                        ...
                        @can('view_all_orders')
                          @if (in_array($user->id, $allowedUserIds))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('order.allPendingForApprovalOrder') }}" class="aiz-side-nav-link {{ areActiveRoutes(['order.allPendingForApprovalOrder']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('All Pending For Approval Orders') }}</span>
                                </a>
                            </li>
                          @endif
                        @endcan
                        @can('view_all_orders')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('order.allSplitOrder') }}" class="aiz-side-nav-link {{ areActiveRoutes(['order.allSplitOrder','order.splitOrder','order.splitOrderDetails','order.reallocationSplitOrder','order.subOrderreallocationSplitOrder']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('All Split Orders') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('view_all_orders')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('order.allPreClosedOrder') }}" class="aiz-side-nav-link {{ areActiveRoutes(['order.allPreClosedOrder','order.preClosedOrderDetails']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('All Pre Closed Orders') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('view_all_orders')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('order.allPendingOrder') }}" class="aiz-side-nav-link {{ areActiveRoutes(['order.allPendingOrder']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('All Pending Orders') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('view_all_orders')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('order.allChallan') }}" class="aiz-side-nav-link {{ areActiveRoutes(['order.allChallan','order.challanDetails','challans.view.products']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Challans') }}</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('view_all_orders')
                             <li class="aiz-side-nav-item">
                            <a href="{{ route('invoice.orders') }}" class="aiz-side-nav-link {{ areActiveRoutes(['invoice.orders', 'invoice.products']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Invoiced Orders') }}</span>
                            </a>
                        </li>
                        @endcan
                         ...
                         @can('view_all_orders')
                             <li class="aiz-side-nav-item">
                            <a href="{{ route('btr.receipts') }}" class="aiz-side-nav-link ">
                                <span class="aiz-side-nav-text">{{ translate('BTR Received') }}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_all_orders')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_unpushed_orders') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_unpushed_orders', 'unpushed_order_show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Pending Payment Orders (SZ Unpushed)') }}</span>
                                </a>
                            </li>
                        @endcan
                          ...
                          @can('view_inhouse_orders')
                              <li class="aiz-side-nav-item">
                                  <a href="{{ route('inhouse_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['inhouse_orders.index', 'inhouse_orders.show']) }}">
                                      <span class="aiz-side-nav-text">{{ translate('Warehouse orders') }}</span>
                                  </a>
                              </li>
                          @endcan
                          ...
                          @endcan
  					            --}}
                        {{-- Uncomment this section if you want to enable Pick-up Point Orders in the future --}}
                      ...
                      @if ($user->id === 1 || $user->id === 180 || $user->id === 169 || $user->id === 25606 )

                               <li class="aiz-side-nav-item">
                                    <a href="{{route('pending.dispatch.orders')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Pending Dispatch Order') }}</span>
                                    </a>
                                </li>
                             
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('dispatch.data')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Dispatch Order') }}</span>
                                    </a>
                                </li>
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('bills.data')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Bills Order') }}</span>
                                    </a>
                                </li>
                            
                            
                               {{--  <li  class="aiz-side-nav-item">
                                    <a href="{{route('order.logistics')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Logistics Order') }}</span>
                                    </a>
                                </li> --}}
                        ...
                        @endif
                        @if ($user->id === 1 || $user->id === 180 || $user->id === 169 || $user->id === 25606 || ($staff && $staff->role_id == 4))
                            <li class="aiz-side-nav-item">
                                <a href="{{route('order.logistics')}}" class="aiz-side-nav-link {{ areActiveRoutes(['order.logistics']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Logistics Order') }}</span>
                                </a>
                            </li>
                        @endif
                ...
                @php
                  ...
                  if ($user->id === 1 || $user->id === 180 || $user->id === 169 || $user->id === 25606) {
                      ...
                      $user->givePermissionTo('view_all_customers');
                  } 
                @endphp
                @canany(['view_all_customers', 'view_classified_products', 'view_classified_packages'])
                  ...
                  <li style="display:none;" class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                      ...
                      <span class="aiz-side-nav-text">{{ translate('Purchase Order') }}</span>
                      <span class="aiz-side-nav-arrow"></span>
                    </a>

                    <ul class="aiz-side-nav-list level-3"> 
                      <li class="aiz-side-nav-item">
                        <a href="{{route('admin.purchase_order')}}"
                          class="aiz-side-nav-link {{ areActiveRoutes(['refund_requests_all', 'reason_show']) }}">
                          <span class="aiz-side-nav-text">{{ translate('Negative Inventory Stock') }}</span>
                        </a>
                      </li>
                    
                    
                      <li class="aiz-side-nav-item">
                        <a href="{{route('finalized.purchase.orders')}}" class="aiz-side-nav-link">
                          <span class="aiz-side-nav-text">{{ translate('Supply order List') }}</span>
                        </a>
                      </li>
                      ...
                      <li class="aiz-side-nav-item">
                        <a href="{{route('final.purchase.orders')}}" class="aiz-side-nav-link">
                          <span class="aiz-side-nav-text">{{ translate('Final Purchase List') }}</span>
                        </a>
                      </li>
                    </ul>
                  </li>
                ...
                <!-- New Purchase Order start -->
              @php
                  $user = auth()->user();

                  // (optional) keep your special-case permission grant
                  if (in_array($user->id, [1, 180, 169, 25606])) {
                      $user->givePermissionTo('view_all_customers');
                  }

                  // allow by title
                  $allowedTitles = ['dispatch', 'head_manager', 'super_boss'];

                  // final gate: either title allowed OR existing permissions allowed
                  $canSeePO = in_array($user->user_title, $allowedTitles)
                              || $user->canany(['view_all_customers', 'view_classified_products', 'view_classified_packages']);
              @endphp
              ...
              @if ($canSeePO)
                  <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                      <i class="las la-user-friends aiz-side-nav-icon"></i>
                      <span class="aiz-side-nav-text">{{ translate('PO') }}</span>
                      <span class="aiz-side-nav-arrow"></span>
                    </a>

                    <ul class="aiz-side-nav-list level-3"> 
                      <li class="aiz-side-nav-item">
                        <a href="{{ route('admin.purchasebag') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['admin.makePurchaseOrder', 'reason_show']) }}">
                          <span class="aiz-side-nav-text">{{ translate('Negative Inventory Stock') }}</span>
                        </a>
                      </li>

                      <li class="aiz-side-nav-item">
                        <a href="{{ route('admin.supplyOrderLising') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['productInformation', 'admin.supplyOrderLising']) }}">
                      ...
                      <li class="aiz-side-nav-item">
                        <a href="{{ route('purchase.invoices.list') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['purchase.invoices.list','purchase-order.view']) }}">
                          <span class="aiz-side-nav-text">{{ translate('Purchase Invoice Register') }}</span>
                        </a>
                      </li>

                      <li class="aiz-side-nav-item">
                        <a href="{{ route('purchase.credit.note.list') }}" class="aiz-side-nav-link">
                          <span class="aiz-side-nav-text">{{ translate('Credit Note Register') }}</span>
                        </a>
                      </li>

                      <li class="aiz-side-nav-item">
                        <a href="{{ route('purchase.debit.note.list') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['purchase.debit.note.list', 'admin.viewDebitNotePurchaseOrder']) }}">
                          <span class="aiz-side-nav-text">{{ translate('Create Debit Note') }}</span>
                        </a>
                      </li>

                      <li class="aiz-side-nav-item">
                        <a href="{{ route('admin.viewManualMakePurchaseOrder') }}" class="aiz-side-nav-link">
                          <span class="aiz-side-nav-text">{{ translate('Create Purchase') }}</span>
                        </a>
                      </li>
                    </ul>
                  </li>
              @endif
              <!-- New Purchase Order end -->
              ...
              @if(in_array($user->user_title, ['super_boss', 'head_manager', 'manager'], true))
                  <li class="aiz-side-nav-item">
                      <a href="{{ route('adminStatement') }}" class="aiz-side-nav-link">
                          <i class="las la-user-friends aiz-side-nav-icon"></i>
                          <span class="aiz-side-nav-text">{{ translate('Statement') }}</span>
                      </a>
                  </li>
              @endif
                ...
                @if ($user->id === 1 || $user->id === 180 || $user->id === 169 || $user->id === 25606)
                  <li class="aiz-side-nav-item">
                      <a href="{{ route('busy.export') }}" class="aiz-side-nav-link">
                          <i class="las la-user-friends aiz-side-nav-icon"></i>
                          <span class="aiz-side-nav-text">{{ translate('Busy Export') }}</span>
                      </a>
                  </li>
              @endif
                ...
                @php
                  $user = auth()->user();
                  if ($user->id === 1 || $user->id === 180 || $user->id === 169 || $user->id === 25606) {
                      // Assign the 'view_rewards' permission
                      $user->givePermissionTo('view_rewards');
                  }
                @endphp
                @canany(['view_rewards'])
                  <li class="aiz-side-nav-item">
                      <a  href="#"  class="aiz-side-nav-link">
                        <i class="las la-medal aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Rewards') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                      </a>
                      <ul class="aiz-side-nav-list level-3"> 
                        <li class="aiz-side-nav-item">
                          <a href="{{route('reward.rewardUserList')}}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['refund_requests_all', 'reason_show']) }}">
                            <span class="aiz-side-nav-text">{{ translate('Logistics Discount List') }}</span>
                          </a>
                        </li>
                        <li class="aiz-side-nav-item">
                          <a href="{{route('reward.usersRewardsPoints')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Users Reward Points') }}</span>
                          </a>
                        </li>

                        <li class="aiz-side-nav-item">
                          <a href="{{ route('manual.reward.points') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Manual Reward Points') }}</span>
                          </a>
                        </li>
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('admin.early_payment.reminders') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Early Payment Reward Reminder') }}</span>
                          </a>
                        </li>
                      </ul> 
                  </li>
               ...
               {{-- WhatsApp Carousel --}}
                @auth
                  @if (auth()->id() === 1)
                    ...
                    <li class="aiz-side-nav-item">
                      <a href="#" class="aiz-side-nav-link">
                        <i class="lab la-whatsapp aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Meta Carousel') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                      </a>
                
                      <ul class="aiz-side-nav-list level-3">
                        <li style="display: none;" class="aiz-side-nav-item">
                          <a href="{{ route('wa.carousel.create-template.form') }}"
                             class="aiz-side-nav-link {{ areActiveRoutes(['wa.carousel.create-template.form','wa.carousel.create-template']) }}">
                            <span class="aiz-side-nav-text">{{ translate('Create Template') }}</span>
                          </a>
                        </li>
                
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('wa.carousel.templates') }}"
                             class="aiz-side-nav-link {{ areActiveRoutes(['wa.carousel.templates']) }}">
                            <span class="aiz-side-nav-text">{{ translate('Templates') }}</span>
                          </a>
                        </li>
                
                        <li style="display: none;" class="aiz-side-nav-item">
                          <a  href="{{ route('wa.carousel.send.form') }}" class="aiz-side-nav-link">
                            <i class="lab la-whatsapp aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">Send Carousel</span>
                          </a>
                        </li>
                      </ul>
                    </li>
              ...
              <li class="aiz-side-nav-item">
                  <a href="#" class="aiz-side-nav-link">
                      ...
                      <span class="aiz-side-nav-text">{{ translate('PDF Content') }}</span>
                      <span class="aiz-side-nav-arrow"></span>
                  </a>
                  <ul class="aiz-side-nav-list level-3">
                      <li class="aiz-side-nav-item">
                          <a href="{{ route('pdf_contents.index') }}" class="aiz-side-nav-link">
                              <span class="aiz-side-nav-text">{{ translate('Manage PDF Content') }}</span>
                          </a>
                      </li>
                  </ul>
              </li>

                <!-- Our Offers (visible only to super_boss, head_manager, manager) -->
                @php
                    $user = auth()->user();
                    $allowedTitles = ['super_boss','head_manager','manager'];
                @endphp

                @if (in_array($user->user_title, $allowedTitles, true))
                    <li class="aiz-side-nav-item {{ areActiveRoutes([
                            'offer-products.create',
                            'offers.index',
                            'offer-combination-products.combo-set-create',
                            'offer.combinations.list',
                            'offer-products.edit',
                            'offer-products.view'
                        ]) ? 'mm-active' : '' }}">
                        <a href="#" class="aiz-side-nav-link {{ areActiveRoutes([
                            ...
                            <i class="las la-user-friends aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Our Offers') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>

                        <ul class="aiz-side-nav-list level-3">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('offer-products.create') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['offer-products.create','offer-products.edit','offer-products.view']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Add Offer Product') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('offers.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['offers.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Offer List') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item" style="display:none;">
                                <a href="{{ route('offer-combination-products.combo-set-create') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['offer-combination-products.combo-set-create']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Combo Set') }}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item" style="display:none;">
                                <a href="{{ route('offer.combinations.list') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['offer.combinations.list']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Combo Set List') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
               ...
               <!-- Abandoned Cart -->
                ...
                @if (in_array($user->user_title, ['super_boss', 'head_manager', 'manager'], true))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('abandoned.cartlist') }}" class="aiz-side-nav-link">
                            <i class="las la-user-friends aiz-side-nav-icon"></i>
             ...
             {{-- warranty --}}
              @php
                $isShow = request()->routeIs('claims.show');
                $from   = request('from'); // pending | approved | rejected | draft | completed
              @endphp
              ...
              <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-3
                           {{ request()->routeIs('claims.pending')    ? 'mm-show' : '' }}
                           {{ request()->routeIs('claims.approved')   ? 'mm-show' : '' }}
                           {{ request()->routeIs('claims.rejected')   ? 'mm-show' : '' }}
                           {{ request()->routeIs('claims.draft')      ? 'mm-show' : '' }}
                           {{ request()->routeIs('claims.completed')  ? 'mm-show' : '' }}
                           {{ ($isShow && in_array($from, ['pending','approved','rejected','draft','completed'])) ? 'mm-show' : '' }}">
                  
                  {{-- Completed (NEW - show first) --}}
                  <li class="aiz-side-nav-item">
                    <a href="{{ route('claims.completed') }}"
                       class="aiz-side-nav-link
                              {{ request()->routeIs('claims.completed') ? 'active' : '' }}
                              {{ ($isShow && $from === 'completed') ? 'active' : '' }}">
                      <span class="aiz-side-nav-text">{{ translate('Completed') }}</span>
                    </a>
                  </li>

                  <li class="aiz-side-nav-item">
                    <a href="{{ route('claims.pending') }}"
                       class="aiz-side-nav-link
                              {{ request()->routeIs('claims.pending') ? 'active' : '' }}
                              {{ ($isShow && $from==='pending') ? 'active' : '' }}">
                      <span class="aiz-side-nav-text">{{ translate('Pending') }}</span>
                    </a>
                  </li>

                  <li class="aiz-side-nav-item">
                    <a href="{{ route('claims.approved') }}"
                       class="aiz-side-nav-link
                              {{ request()->routeIs('claims.approved') ? 'active' : '' }}
                              {{ ($isShow && $from==='approved') ? 'active' : '' }}">
                      <span class="aiz-side-nav-text">{{ translate('Approved') }}</span>
                    </a>
                  </li>

                  <li class="aiz-side-nav-item">
                    <a href="{{ route('claims.rejected') }}"
                       class="aiz-side-nav-link
                              {{ request()->routeIs('claims.rejected') ? 'active' : '' }}
                              {{ ($isShow && $from==='rejected') ? 'active' : '' }}">
                      <span class="aiz-side-nav-text">{{ translate('Rejected') }}</span>
                    </a>
                  </li>

                  <li class="aiz-side-nav-item">
                    <a href="{{ route('claims.draft') }}"
                       class="aiz-side-nav-link
                              {{ request()->routeIs('claims.draft') ? 'active' : '' }}
                              {{ ($isShow && $from==='draft') ? 'active' : '' }}">
                      <span class="aiz-side-nav-text">{{ translate('Draft') }}</span>
                    </a>
                  </li>
                </ul>
              </li>
               ...
               <!-- Customers -->
                @php
                    ...
                    // (optional) auto-grant once, if you DO want real access too
                    // if (in_array($user->user_title, ['dispatch','head_manager','super_boss','manager'])
                    //     && !$user->hasPermissionTo('view_all_customers')) {
                    //     $user->givePermissionTo('view_all_customers');
                    // }

                    // Allow via title OR permission (so dispatch bhi dekh sake)
                    $allowedTitles         = ['dispatch','head_manager','super_boss','manager'];
                    $canByTitle            = in_array($user->user_title, $allowedTitles, true);

                    $canCustomersList      = $canByTitle || $user->can('view_all_customers');
                    $canClassifiedProducts = $canByTitle || $user->can('view_classified_products');
                    $canClassifiedPackages = $canByTitle || $user->can('view_classified_packages');

                    $classifiedOn          = get_setting('classified_product') == 1;

                    // Show parent only if at least one child will be visible AND not blocked user
                    $hasAnyChild = $canCustomersList
                                   || ($classifiedOn && ($canClassifiedProducts || $canClassifiedPackages));
                @endphp
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-3">
                            @if($canCustomersList)
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('topSellingCategories') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Customer Top Selling Category') }}</span>
                                    </a>
                                </li>
                            @endif

                            @if($classifiedOn)
                                @if($canClassifiedProducts)
                                    <li class="aiz-side-nav-item">
                    ...
                    @if (auth()->id() === 1)
                      <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                          ...
                          <span class="aiz-side-nav-text">{{ translate('Push Notifications') }}</span>
                          <span class="aiz-side-nav-arrow"></span>
                        </a>
                        ...
                        <ul class="aiz-side-nav-list level-3"> 
                          <li class="aiz-side-nav-item">
                            <a href="{{route('getNotifications')}}"
                              class="aiz-side-nav-link">
                              <span class="aiz-side-nav-text">{{ translate('All Notifications') }}</span>
                            </a>
                          </li>                   
                      ...
                      <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                          <i class="las la-comments aiz-side-nav-icon"></i>
                          <span class="aiz-side-nav-text">{{ translate('Cron Jobs') }}</span>
                          <span class="aiz-side-nav-arrow"></span>
                        </a>
    
                        <ul class="aiz-side-nav-list level-3"> 
                          <li class="aiz-side-nav-item">
                            <a href="{{ route('getCronJobs') }}"
                              class="aiz-side-nav-link">
                              <span class="aiz-side-nav-text">{{ translate('Active Cron Jobs') }}</span>
                            </a>
                          </li>                   
                ...
                @canany(['in_house_product_sale_report', 'seller_products_sale_report', 'products_stock_report',
                  'product_wishlist_report', 'user_search_report', 'commission_history_report', 'wallet_transaction_report'])
                  <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                      ...
                      @can('in_house_product_sale_report')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('in_house_sale_report.index') }}"
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Warehouse Product Sale') }}</span>
                          </a>
                        </li>
                      @endcan
                      ...
                      @can('commission_history_report')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('commission-log.index') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Seller Credit Notes') }}</span>
                          </a>
                        </li>
                      @endcan
                ...
                <!-- Website Setup -->
                @canany(['header_setup', 'footer_setup', 'view_all_website_pages', 'website_appearance', 'edit_sitemap',
                  'edit_robots'])
                  <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-3">
                      ...
                      @can('edit_sitemap')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('website.sitemap') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['website.sitemap']) }}">
                            <span class="aiz-side-nav-text">{{ translate('Sitemap') }}</span>
                          </a>
                        </li>
                      @endcan
                      @can('edit_robots')
                        <li class="aiz-side-nav-item">
                          <a href="{{ route('website.robots') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['website.robots']) }}">
                            <span class="aiz-side-nav-text">{{ translate('Robots') }}</span>
                          </a>
                        </li>
                      @endcan
                    </ul>
    ...
    @if (! $is41Manager)
      <div class="aiz-side-nav-wrap">
        <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
          ...
          <li class="aiz-side-nav-item">
            <a href="#" class="aiz-side-nav-link">
              <i class="las la-ship aiz-side-nav-icon"></i>
              <span class="aiz-side-nav-text">{{ translate('International') }}</span>
              <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-2" style="list-style-type: none; padding-left: 0; margin-left: 0;">
              <li class="aiz-side-nav-item" style="list-style-type: none; padding-left: 0; margin-left: 0;">
                <a href="#" class="aiz-side-nav-link">
                  <i class="las la-user-friends aiz-side-nav-icon"></i>
                  <span class="aiz-side-nav-text">{{ translate('Customers') }}</span>
                  <span class="aiz-side-nav-arrow"></span>
                </a>
                <!-- Submenu under Product 1 -->
                <ul class="aiz-side-nav-list level-3">
                  <li class="aiz-side-nav-item">
                    <a class="aiz-side-nav-link" href="{{ route('customers.ownBrandCustomer') }}">
                      <span class="aiz-side-nav-text">{{ translate('Customer List') }}</span>
                    </a>
                  </li>
                </ul>
              ...
              <li class="aiz-side-nav-item" style="list-style-type: none; padding-left: 0; margin-left: 0;">
                ...
                <ul class="aiz-side-nav-list level-3">
                  <li class="aiz-side-nav-item">
                    <a class="aiz-side-nav-link" href="{{ route('category-groups.ownBrandCategoryGroups') }}">
                      <span class="aiz-side-nav-text">{{ translate('Category Group List') }}</span>
                    </a>
                  </li>
                </ul>
                <ul class="aiz-side-nav-list level-3">
                  <li class="aiz-side-nav-item">
                    <a class="aiz-side-nav-link" href="{{ route('categories.ownBrandCategories') }}">
                      <span class="aiz-side-nav-text">{{ translate('Category List') }}</span>
                    </a>
                  </li>
                </ul>
                <ul class="aiz-side-nav-list level-3">
                  <li class="aiz-side-nav-item">
                    <a class="aiz-side-nav-link" href="{{ route('products.allOwnBrandProducts') }}">
                      <span class="aiz-side-nav-text">{{ translate('Product List') }}</span>
                    </a>
                  </li>
                </ul>
                <ul class="aiz-side-nav-list level-3">
                  <li class="aiz-side-nav-item">
                    <a class="aiz-side-nav-link {{ areActiveRoutes(['uploaded-files.own_brand_all_file']) }}"
                      href="{{ route('uploaded-files.own_brand_all_file') }}">
                      <span class="aiz-side-nav-text">{{ translate('Upload Product Images') }}</span>
                    </a>
                  </li>
                </ul>
                <!-- <ul class="aiz-side-nav-list level-3">
                  <li class="aiz-side-nav-item">
                    <a class="aiz-side-nav-link" href="{{ route('uploaded-files.own_brand_all_file') }}">
                      <span class="aiz-side-nav-text">{{ translate('Upload Own Brand Files') }}</span>
                    </a>
                  </li>
                </ul> -->
              </li>
              <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('all_international_orders') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_international_orders', 'international_pending_order_details']) }}">
                            <span class="aiz-side-nav-text">{{ translate('All Pending Orders') }}</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('all_international_in_review_orders') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_international_in_review_orders', 'international_pending_order_details']) }}">
                            <span class="aiz-side-nav-text">{{ translate('All In Review Orders') }}</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('all_international_approved_orders') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_international_approved_orders', 'international_confirm_order_details']) }}">
                            <span class="aiz-side-nav-text">{{ translate('All Approved Orders') }}</span>
                        </a>
                    </li>
                </ul>
              </li>
...
{{-- 41 Manager (Customers + Products + Busy Export + Sales) --}}
@if ($is41Manager)
  <div class="aiz-side-nav-wrap">
    <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
      ...
      @php
        $groupRoutes = [
          ...
          // Products
          'products.all','products.closingStock',
          // Busy
          'busy.export',
          // Sales - Orders
          'all_orders.index','all_orders.show',
          'order.allPendingOrder',
          'order.allChallan','order.challanDetails','challans.view.products',
          'orders.cancelled','order.allPreClosedOrder','order.preClosedOrderDetails',
          // Sales - Split Orders
          'sub_orders.index','sub_orders.show','sub_orders.edit',
          'order.allSplitOrders','order.splitOrderDetails',
          // PO
          'admin.purchasebag',
          'admin.supplyOrderLising','productInformation',
          'purchase.invoices.list','purchase-order.view',
          'purchase.credit.note.list',
          'purchase.debit.note.list','admin.viewDebitNotePurchaseOrder',
          'admin.viewManualMakePurchaseOrder',
          'manager41.statement',

          'manager41.order.logistics.create',
          'manager41.order.logistics.edit',
        ];
      @endphp

      <li class="aiz-side-nav-item {{ areActiveRoutes($groupRoutes) ? 'mm-active' : '' }}">
        <a href="#"
           class="aiz-side-nav-link {{ areActiveRoutes($groupRoutes) ? 'level-3-active' : '' }}">
          <i class="las la-user-shield aiz-side-nav-icon"></i>
          <span class="aiz-side-nav-text">{{ translate('41 Manager') }}</span>
          <span class="aiz-side-nav-arrow"></span>
        </a>
        ...
        <ul class="aiz-side-nav-list level-2" style="list-style-type:none;padding-left:0;margin-left:0;">
          ...
          <li class="aiz-side-nav-item" style="list-style-type:none;padding-left:0;margin-left:0;">
            ...
            <ul class="aiz-side-nav-list level-3">
              <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link {{ areActiveRoutes(['customers.index','customers.create','customers.edit']) }}"
          ...
          <li class="aiz-side-nav-item" style="list-style-type:none;padding-left:0;margin-left:0;">
            ...
            <ul class="aiz-side-nav-list level-3">
              <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link {{ areActiveRoutes(['products.all']) }}"
                   href="{{ route('products.all') }}">
                  <span class="aiz-side-nav-text">{{ translate('All Products') }}</span>
                </a>
              </li>
              <li class="aiz-side-nav-item">
                <a class="aiz-side-nav-link {{ areActiveRoutes(['products.closingStock']) }}"
                   href="{{ route('products.closingStock') }}">
                  <span class="aiz-side-nav-text">{{ translate('Closing Stock') }}</span>
                </a>
              </li>
            </ul>
          ...
          {{-- Busy Export --}}
          <li class="aiz-side-nav-item">
            <a href="{{ route('busy.export') }}"
               class="aiz-side-nav-link {{ areActiveRoutes(['busy.export']) }}">
              <i class="las la-file-export aiz-side-nav-icon"></i>
              <span class="aiz-side-nav-text">{{ translate('Busy Export') }}</span>
            </a>
          </li>
          ...
          <li class="aiz-side-nav-item" style="list-style-type:none;padding-left:0;margin-left:0;">
            ...
            <ul class="aiz-side-nav-list level-3">
              ...
              {{-- Pending Orders --}}
              <li class="aiz-side-nav-item">
                <a href="{{ route('order.allPendingForApprovalOrder') }}"
                   class="aiz-side-nav-link {{ areActiveRoutes(['order.allPendingForApprovalOrder']) }}">
                  <span class="aiz-side-nav-text">{{ translate('All Pending Orders') }}</span>
                </a>
              </li>
              ...
              {{-- Challans --}}
              <li class="aiz-side-nav-item">
                <a href="{{ route('order.allChallan') }}"
                   class="aiz-side-nav-link {{ areActiveRoutes(['order.allChallan','order.challanDetails','challans.view.products','manager41.order.logistics.create','manager41.order.logistics.edit']) }}">
                  <span class="aiz-side-nav-text">{{ translate('Challans') }}</span>
                </a>
              </li>
          ...
          {{-- Statement --}}
            @if (Route::has('manager41.statement'))
              <li class="aiz-side-nav-item">
                <a href="{{ route('manager41.statement') }}"
                   class="aiz-side-nav-link {{ areActiveRoutes(['manager41.statement']) }}">
          ...
          <li class="aiz-side-nav-item" style="list-style-type:none;padding-left:0;margin-left:0;">
            ...
            <ul class="aiz-side-nav-list level-3">
              <!-- <li class="aiz-side-nav-item">
                <a href="{{ route('admin.purchasebag') }}"
                   class="aiz-side-nav-link {{ areActiveRoutes(['admin.purchasebag']) }}">
                  <span class="aiz-side-nav-text">{{ translate('Negative Inventory Stock') }}</span>
                </a>
              </li>
              ...
              <li class="aiz-side-nav-item">
                <a href="{{ route('admin.supplyOrderLising') }}"
                   class="aiz-side-nav-link {{ areActiveRoutes(['admin.supplyOrderLising','productInformation']) }}">
                  <span class="aiz-side-nav-text">{{ translate('Purchase Orders') }}</span>
                </a>
              </li> -->
              ...
              <!-- <li class="aiz-side-nav-item">
                <a href="{{ route('purchase.credit.note.list') }}"
                   class="aiz-side-nav-link {{ areActiveRoutes(['purchase.credit.note.list']) }}">
                  <span class="aiz-side-nav-text">{{ translate('Credit Note Register') }}</span>
                </a>
              </li>
              ...
              <li class="aiz-side-nav-item">
                <a href="{{ route('admin.manualMakePurchaseOrder41') }}"
                   class="aiz-side-nav-link {{ areActiveRoutes(['admin.manualMakePurchaseOrder41']) }}">
                  <span class="aiz-side-nav-text">{{ translate('Create Purchase') }}</span>
                </a>
              </li>
            </ul>
...
@php
    $user = auth()->user();
    $accessUserIds = [1, 25606];
@endphp
@if(in_array($user->id, $accessUserIds))
  <div class="aiz-side-nav-wrap">
      <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">

          @php
              // Import Company ke routes
              $importCompanyRoutes  = ['import_companies.index', 'import_companies.create'];

              // Supplier ke routes
              $supplierListRoutes   = ['import_suppliers.index'];
              $supplierCreateRoutes = ['import_suppliers.create'];
              $importSupplierRoutes = array_merge($supplierListRoutes, $supplierCreateRoutes);

              // BL routes
              //$blDetailRoutes       = ['import_bl_details.index'];
              $blDetailRoutes       = ['import_bl_details.index', 'import_bl_details.pending'];

              // 🔹 NEW: CI Listing routes
              $ciListRoutes         = ['import_ci.index'];

              // Parent "Import CI" ke liye combined routes
              $importCiRoutes = array_merge(
                  $importCompanyRoutes,
                  $importSupplierRoutes,
                  $blDetailRoutes,
                  $ciListRoutes          // 🔹 NEW
              );
          @endphp

          {{-- Level 1: Import Commercial Invoice --}}
          <li class="aiz-side-nav-item {{ areActiveRoutes($importCiRoutes) ? 'mm-active' : '' }}">
              <a href="#"
                 class="aiz-side-nav-link {{ areActiveRoutes($importCiRoutes) ? 'level-3-active' : '' }}">
                  <i class="las la-ship aiz-side-nav-icon"></i>
                  <span class="aiz-side-nav-text">{{ translate('Import CI') }}</span>
                  <span class="aiz-side-nav-arrow"></span>
              </a>
              ...
              <ul class="aiz-side-nav-list level-2">
                  ...
                  <li class="aiz-side-nav-item {{ areActiveRoutes($importCompanyRoutes) ? 'mm-active' : '' }}">
                      <a href="#"
                         class="aiz-side-nav-link {{ areActiveRoutes($importCompanyRoutes) ? 'level-3-active' : '' }}">
                          <i class="las la-building aiz-side-nav-icon"></i>
                          <span class="aiz-side-nav-text">{{ translate('Import Company') }}</span>
                          <span class="aiz-side-nav-arrow"></span>
                      </a>

                      <ul class="aiz-side-nav-list level-3">
                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_companies.create') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes(['import_companies.create']) ? 'active' : '' }}">
                                  <i class="las la-plus-circle aiz-side-nav-icon"></i>
                                  <span class="aiz-side-nav-text">{{ translate('Add Import Company') }}</span>
                              </a>
                          </li>

                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_companies.index') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes(['import_companies.index']) ? 'active' : '' }}">
                                  <i class="las la-list aiz-side-nav-icon"></i>
                                  <span class="aiz-side-nav-text">{{ translate('Import Company List') }}</span>
                              </a>
                          </li>
                      </ul>
                  </li>
                  ...
                  {{-- Suppliers group --}}
                  <li class="aiz-side-nav-item {{ areActiveRoutes($importSupplierRoutes) ? 'mm-active' : '' }}">
                      <a href="#"
                         class="aiz-side-nav-link {{ areActiveRoutes($importSupplierRoutes) ? 'level-3-active' : '' }}">
                          <i class="las la-user-friends aiz-side-nav-icon"></i>
                      ...
                      <ul class="aiz-side-nav-list level-3">
                          {{-- Add Supplier --}}
                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_suppliers.create') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes($supplierCreateRoutes) ? 'active' : '' }}">
                                  <i class="las la-plus-circle aiz-side-nav-icon"></i>
                                  <span class="aiz-side-nav-text">{{ translate('Add Supplier') }}</span>
                              </a>
                          </li>

                          {{-- Supplier List --}}
                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_suppliers.index') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes($supplierListRoutes) ? 'active' : '' }}">
                                  <i class="las la-list aiz-side-nav-icon"></i>
                  ...
                  <li class="aiz-side-nav-item {{ areActiveRoutes($blDetailRoutes) ? 'mm-active' : '' }}">
                      <a href="#"
                         class="aiz-side-nav-link {{ areActiveRoutes($blDetailRoutes) ? 'level-3-active' : '' }}">
                          <i class="las la-file-contract aiz-side-nav-icon"></i>
                          <span class="aiz-side-nav-text">{{ translate('Bill of Lading') }}</span>
                          <span class="aiz-side-nav-arrow"></span>
                      </a>
                      ...
                      <ul class="aiz-side-nav-list level-3">
                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_bl_details.index') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes($blDetailRoutes) ? 'active' : '' }}">
                                  <i class="las la-list aiz-side-nav-icon"></i>
                                  <span class="aiz-side-nav-text">{{ translate('BL Details') }}</span>
                              </a>
                          </li>
                          ...
                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_bl_details.pending') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes(['import_bl_details.pending']) ? 'active' : '' }}">
                                  <i class="las la-clock aiz-side-nav-icon"></i>
                                  <span class="aiz-side-nav-text">{{ translate('Pending BL') }}</span>
                              </a>
                          </li>

                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_bl_details.completed') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes(['import_bl_details.completed']) ? 'active' : '' }}">
                                  <i class="las la-check-circle aiz-side-nav-icon"></i>
                                  <span class="aiz-side-nav-text">{{ translate('Completed BL') }}</span>
                              </a>
                          </li>
                  ...
                  {{-- 🔹 Commercial Invoice group (NEW) --}}
                  <li class="aiz-side-nav-item {{ areActiveRoutes($ciListRoutes) ? 'mm-active' : '' }}">
                      <a href="#"
                         class="aiz-side-nav-link {{ areActiveRoutes($ciListRoutes) ? 'level-3-active' : '' }}">
                          <i class="las la-file-invoice-dollar aiz-side-nav-icon"></i>
                          <span class="aiz-side-nav-text">{{ translate('Commercial Invoice') }}</span>
                          <span class="aiz-side-nav-arrow"></span>
                      </a>
                      ...
                      <ul class="aiz-side-nav-list level-3">
                          <li class="aiz-side-nav-item">
                              <a href="{{ route('import_ci.index') }}"
                                 class="aiz-side-nav-link {{ areActiveRoutes($ciListRoutes) ? 'active' : '' }}">
                                  <i class="las la-list aiz-side-nav-icon"></i>
                                  <span class="aiz-side-nav-text">{{ translate('CI Listing') }}</span>
                              </a>
                          </li>
                      </ul>
                  </li>
...
@endif
    ...
    <?php /*<div class="aiz-side-nav-wrap">
      <div class="px-20px mb-3">
        <input class="form-control bg-soft-secondary border-0 form-control-sm text-white" type="text" name=""
          placeholder="{{ translate('Search in menu') }}" id="menu-search" onkeyup="menuSearch()">
      </div>
      ...
      <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
        ...
        @php
          ...
          // Check if the logged-in user has one of the specific IDs
          $allowedUserIds = [1, 180, 169, 25606];
          if (in_array($user->id, $allowedUserIds)) {
              // Assign the 'view_all_orders' permission to the user
              $user->givePermissionTo('view_all_orders');
          }
        @endphp
