        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Model No.') }} <span
                    class="text-danger">*</span></label>
                <div class="col-md-8">
                  <input type="text" class="form-control" name="model_no" placeholder="{{ translate('Model No.') }}"
                    onchange="update_sku()" required>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Part No.') }} <span
                    class="text-danger">*</span></label>
                <div class="col-md-8">
              ...
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Generic Names') }} <span
                    class="text-danger">*</span></label>
                <div class="col-md-8">
                  <input type="text" class="form-control aiz-tag-input" name="generic_name[]"
                    placeholder="{{ translate('Type and hit enter to add a Generic Name') }}">
                  <small
                    class="text-muted">{{ translate('This is used for searching for Accessories and Spares. Enter the generic Model no of this product.') }}</small>
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="mb-0 h6">{{ translate('Product Price & Stocks') }}</h5>
            </div>
            <div class="card-body">
              <div class="form-group row">
                <div class="col-md-3">
              ...
              <div class="form-group row">
                <div class="col-md-3">
                  <label class="col-from-label">{{ translate('Seller') }} <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-9">
                  <select class="form-control aiz-selectpicker" data-live-search="true"
                    data-placeholder="{{ translate('Select the Seller') }}" name="seller_id" required>
                    <option value="">{{ translate('Select the Seller') }}</option>
                    @foreach (\App\Models\Seller::with('user.warehouse')->get() as $key => $seller)
                      <option value="{{ $seller->id }}">
                        {{ $seller->user->name . ' - ' . $seller->user->warehouse->name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Price per Carton') }}</label>
                <div class="col-md-6">
                  <input type="number" lang="en" min="0" value="0" step="0.01"
                    placeholder="{{ translate('Price per Carton') }}" name="carton_price" class="form-control">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Pieces per Carton') }}</label>
                <div class="col-md-6">
                  <input type="number" lang="en" min="0" value="10" step="1"
                    placeholder="{{ translate('Pieces per Carton') }}" name="piece_per_carton" class="form-control">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div id="show-hide-div">
                <div class="form-group row">
                  <label class="col-md-3 col-from-label">{{ translate('Warehouse Stock') }} <span
                      class="text-danger">*</span></label>
                  <div class="col-md-6">
                    <input type="number" lang="en" min="0" value="0" step="1"
                      placeholder="{{ translate('Warehouse Stock') }}" name="current_stock" class="form-control"
                      required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-md-3 col-from-label">{{ translate('Seller Stock') }} <span
                      class="text-danger">*</span></label>
                  <div class="col-md-6">
                    <input type="number" lang="en" min="0" value="0" step="1"
                      placeholder="{{ translate('Seller Stock') }}" name="seller_stock" class="form-control" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-md-3 col-from-label">
                  ...
                  <div class="col-md-6">
                    <input type="text" placeholder="{{ translate('Seller SKU') }}" name="seller_sku"
                      class="form-control">
                  </div>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('CBM') }}
                  <small>({!! 'In m<sup>3</sup>' !!})</small></label>
                <div class="col-md-8">
                  <input type="number" class="form-control" name="cbm" step="0.0001" value="0.00"
                    placeholder="0.00">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Carton CBM') }}
                  <small>({!! 'In m<sup>3</sup>' !!})</small></label>
                <div class="col-md-8">
                  <input type="number" class="form-control" name="carton_cbm" step="0.0001" value="0.00"
                    placeholder="0.00">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Length') }}
                  <small>({{ translate('In Cms.') }})</small></label>
                <div class="col-md-8">
                  <input type="number" class="form-control" name="length" step="0.01" value="0.00"
                    placeholder="0.00">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Breadth') }}
                  <small>({{ translate('In Cms.') }})</small></label>
                <div class="col-md-8">
                  <input type="number" class="form-control" name="breadth" step="0.01" value="0.00"
                    placeholder="0.00">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Height') }}
                  <small>({{ translate('In Cms.') }})</small></label>
                <div class="col-md-8">
                  <input type="number" class="form-control" name="height" step="0.01" value="0.00"
                    placeholder="0.00">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Weight') }}
                  <small>({{ translate('In Kgs.') }})</small></label>
                <div class="col-md-8">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <label class="col-md-3 col-from-label">{{ translate('Meta Keywords') }}</label>
                <div class="col-md-8">
