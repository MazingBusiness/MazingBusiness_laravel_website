    ...
    <div class="card">
      <div class="card-body p-0">
        ...
        <form class="p-4" action="{{ route('brands.update', $brand->id) }}" method="POST"
          ...
          <div class="form-group row">
            <label class="col-sm-3 col-from-label" for="name">{{ translate('Markup') }} <i
                class="las la-language text-danger" title="{{ translate('Translatable') }}"></i></label>
            <div class="col-sm-9 input-group">
              <input type="text" placeholder="{{ translate('Markup') }}" id="markup" name="markup"
                value="{{ $brand->markup }}" class="form-control" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea name="meta_keywords" rows="8" class="form-control">{{ $brand->meta_keywords }}</textarea>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <textarea class="aiz-text-editor form-control" placeholder="{{ translate('Content..') }}"
                ...
                data-min-height="300" name="page_description">{!! $brand->page_description !!}</textarea>
            </div>
          </div>
          <div class="form-group row">
