    ...
    <div class="col-lg-8 mx-auto">
      <div class="card">
        <div class="card-body p-0">
          <form class="p-4" action="{{ route('category-groups.update', $category_group->id) }}" method="POST"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="number" name="order" value="{{ $category_group->order }}" class="form-control"
                  id="order" placeholder="{{ translate('Order') }}">
