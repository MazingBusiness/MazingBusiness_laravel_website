{{-- resources/views/.../pl_template_3.blade.php --}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
@foreach($invoices as $index => $invoice)
    @php
        ...
        // SAME TOTALS LOGIC AS pl_template_2
        ...
        // Packing list ke liye PL- prefix hi rakha
    ...
    <div class="pl-wrapper">
        <div class="pl-outer">
            <table class="pl-table">
                ...
                {{-- TO / INVOICE NO + DATE (styled like CI_3) --}}
                <tr class="tight-header to-pl-row">
                    <td colspan="4" class="text-left">
                        <span class="label">To:</span>
                        <span class="red" style="margin-left: 8px;">
                            {{ $importerName }}
                        </span>
                    ...
                    <td colspan="4" class="text-right">
                        <div class="nowrap">
                            <span class="label" style="margin-left: 4px;">Invoice No.:</span>
                            <span class="red value-underline" style="margin-left: 4px;">
                                {{ $invoiceNo }}
                            </span>
                        </div>
                        <div class="nowrap" style="margin-top: 4px;">
                            <span class="label" style="margin-left: 4px;">Date:</span>
                            <span class="red value-underline" style="margin-left: 4px;">
                                {{ $invoiceDate }}
                            </span>
                        </div>
                ...
                {{-- separator under TO row --}}
                <tr class="separator-row">
                    <td colspan="8"></td>
                </tr>

                {{-- FROM / TO block WITH "Letter of Credit No." + "Issued by:" --}}
                <tr>
                    {{-- LEFT: From / Letter of Credit --}}
                    <td colspan="4" class="text-left">
                        <div style="margin-top: 2px;">
                            <span>From:</span>
                            <span class="red value-underline" style="margin-left: 30px;">
                                {{ $fromCity }}
                            </span>
                        </div>

                        <div style="margin-top: 6px;">
                            <span>Letter of Credit No.:</span>
                        </div>
                    </td>
                    ...
                    <td colspan="4" class="text-left">
                        <div style="margin-top: 2px;">
                            <span>To:</span>
                            <span class="red value-underline" style="margin-left: 42px;">
                                {{ $toCity }}
                            </span>
                        </div>
                ...
                {{-- HEADER ROW (same columns as pl_template_2) --}}
                ...
                {{-- DATA ITEM ROWS – EXACT SAME FIELD LOGIC AS pl_template_2 --}}
                @php $sno = 1; @endphp
                @foreach($rows as $row)
                    @php
                ...
                {{-- TOTAL ROW – EXACTLY LIKE pl_template_2 --}}
                <tr>
