{{-- resources/views/.../pl_template_4.blade.php --}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        /* Edge pe double border na aaye – outer box hi dikhe */
        ...
        /* Top header rows: bilkul plain (no inner borders) */
        .top-section-row td {
    ...
    <div class="pl-wrapper">
        <div class="pl-outer">
            <table class="pl-table">
                ...
                {{-- 🔹 Spacer row: little gap before "From / Transport details" line --}}
                <tr class="top-section-row">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <strong>{{ $totalCtns ? number_format($totalCtns, 0) : '' }}</strong>
                    </td>
                    <td class="text-center">
                        <strong>{{ $totalQty  ? number_format($totalQty, 0)  : '' }}</strong>
                    </td>
                    <td class="text-center">
                        <strong>{{ $totalGw   ? number_format($totalGw, 2)   : '' }}</strong>
                    </td>
                    <td class="text-center">
                        <strong>{{ $totalNw   ? number_format($totalNw, 2)   : '' }}</strong>
                    </td>
                    <td class="text-center">
                        <strong>{{ $totalCbm  ? number_format($totalCbm, 3)  : '' }}</strong>
                    </td>
                </tr>
