{{-- resources/views/.../ci_template_3.blade.php --}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
@foreach($invoices as $index => $invoice)
    @php
        ...
        $invoiceDate = $ci->supplier_invoice_date
            ? \Carbon\Carbon::parse($ci->supplier_invoice_date)->format('Y-m-d')
            : now()->format('Y-m-d');
        ...
        <div class="invoice-outer">
            <table class="invoice-table">
                ...
                <tr>
                    ...
                    <th style="width:48%;" class="text-center" colspan="3">Descriptions</th>
                ...
                <tr style="height: 120px;">
                    {{-- 🔹 Bank section wider (4 cols) --}}
                    <td colspan="4" class="bank-cell">
                    ...
                    {{-- 🔹 Buyer stamp (2 cols, equal to supplier) --}}
                    <td colspan="2" class="stamp-cell">
