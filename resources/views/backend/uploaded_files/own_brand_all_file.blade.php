  ...
  <div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 text-md-right">
        <a href="{{ route('uploaded-files.own_brand_file_create') }}" class="btn btn-primary">
        ...
        <div class="row gutters-5">
          @foreach ($all_uploads as $key => $file)
            @php
              ...
              /*
              $file_path = url('/') . '/public/' . $file->file_name;
              */
                ...
                <div class="dropdown-file">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javascript:void(0)" class="dropdown-item confirm-alert"
                      data-href="{{ route('uploaded-files.destroy', $file->id) }}" data-target="#delete-modal">
