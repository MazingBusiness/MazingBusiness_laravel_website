    ...
    <div class="card">
      ...
      <div class="card-body">
          ...
          <div class="col-md-9">
            <label class="aiz-switch aiz-switch-success mb-3">
              <input value="1" name="bank_payment_status" type="checkbox"
                @if ($user->seller->bank_payment_status == 1) checked @endif>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <input type="text" name="bank_name" value="{{ $user->seller->bank_name }}" id="bank_name"
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <input type="text" name="bank_acc_name" value="{{ $user->seller->bank_acc_name }}" id="bank_acc_name"
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <input type="text" name="bank_acc_no" value="{{ $user->seller->bank_acc_no }}" id="bank_acc_no"
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <input type="text" name="bank_ifsc_code" value="{{ $user->seller->bank_ifsc_code }}"
