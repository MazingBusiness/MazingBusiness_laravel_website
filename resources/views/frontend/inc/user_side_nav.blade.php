    ...
    <div class="sidemnenu mb-3">
      <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
        ...
        @else
          ...
          @endif
          <li class="aiz-side-nav-item">
              <a href="{{ route('statement') }}" class="aiz-side-nav-link {{ areActiveRoutes(['statement']) }}">
              <i class="las la-newspaper aiz-side-nav-icon"></i>
                <span class="aiz-side-nav-text">{{ translate('Statement') }}</span>
              </a>
          </li>
          <li class="aiz-side-nav-item">
            <a href="{{ route('rewards') }}" class="aiz-side-nav-link {{ areActiveRoutes(['rewards']) }}">
        ...
        {{-- <li class="aiz-side-nav-item">
          <a href="#" onclick="account_delete_confirm_modal('{{ route('account_delete') }}')"
            class="aiz-side-nav-link">
            <i class="las la-user-times aiz-side-nav-icon"></i>
