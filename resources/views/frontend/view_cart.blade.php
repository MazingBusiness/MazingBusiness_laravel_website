            ...
            <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
              <div class="mb-4">
                <div class="row gutters-5 d-none d-lg-flex border-bottom mb-3 pb-3">
                  ...
                  <div class="col-md-3 fw-600">{{ translate('Price') }}</div>
                    ...
                    <li class="list-group-item px-0 px-lg-3">
                      <div class="row gutters-5">
                        <div class="col-lg-5 d-flex">
                          ...
                          @endphp
                          <img src="{{ $product_thumbnail_path }}" 
                        ...
                        <div class="col-lg-3 col-4 order-1 order-lg-0 my-3 my-lg-0">
                          ...
                          @else
                            <span class="fw-600 fs-16">{{ cart_product_price($cartItem, $product, true, false, Auth::user()->id) }}</span>
                          @endif
                        </div>
                          ...
                          @if ($cartItem['digital'] != 1)
                            {{-- <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                              ...
                              <input type="number" name="quantity[{{ $cartItem['id'] }}]"
                                ...
                                max="{{ $product_stock->qty }}" onchange="updateQuantity({{ $cartItem['id'] }}, this)">
                              <button class="btn col-auto btn-icon btn-sm btn-circle btn-light" type="button"
    ...
    function updateCartPrice(cart_id){
      ...
      $.ajax({
          ...
          success: function (response) {
            $('#divCart').empty(); // Clear the div before appending new data
            $('#divCart').append(response.html); // Append the response data
          },
          complete: function(){
