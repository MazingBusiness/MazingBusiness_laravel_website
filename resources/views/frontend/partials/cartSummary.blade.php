                    ...
                    <li class="list-group-item px-0 px-lg-3" id="cartRow_{{ $cartItem['id'] }}">
                      ...
                      <div class="row gutters-5">
                        ...
                        <div class="col-lg-2 col-4 order-1 order-lg-0 my-3 my-lg-0 text-center">
                          ...
                          @else
                            <span class="fw-600 fs-16" id="spanPrice_{{ $cartItem['id'] }}">{{ single_price(cart_product_price($cartItem, $product, true, false, Auth::user()->id)) }}</span>
                          @endif */ ?>
                        ...
                        <div class="col-lg-2 col-4 order-3 order-lg-0 my-3 my-lg-0 text-center">
                          ...
                          <?php /* @if(session()->has('staff_id') AND (session()->get('staff_id')==180 OR session()->get('staff_id')==169 OR session()->get('staff_id')==25606))
