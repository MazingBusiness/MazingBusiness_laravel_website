...
@if(count($products) > 0)
  ...
  @foreach ($products->filter(function($product) { return $product->is_manager_41 == 1; }) as $key => $product)
        ...
        <div class="d-flex flex-column align-items-start col-3 col-md-3 col-lg-3">
            ...
            @if(
                ...
                $is41
                    ...
                    ? \App\Models\Manager41ProductStock::where('part_no', $part_no)->where('closing_stock', '>', 0)->exists()

                    : \DB::table('products_api')->where('part_no', $part_no)->where('closing_stock', '>', 0)->exists()
